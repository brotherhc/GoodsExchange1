			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header pull-right" role="navigation">
					...
					<ul class="nav nav-list">
						...
						<li class="">
							<a href="${ctx}/attribute/selectl" class="dropdown-toggle">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<c:forEach items="${evaluateid}" var="page">
								<form class="form-horizontal" action= "${ctx}/Evaluate/update/?id=${page.id}"role="form" method="post">
									   ...
									   <div class="form-group">
										   ...
										   <div class="col-sm-5">
											   <input type="text" class="form-control" id="firstname"name="content"
													  placeholder=""  value="${page.content}">
										   </div>
									   </div>
									   <div class="form-group">
										   <div class="col-sm-offset-2 col-sm-6">
											   <button type="submit"  class="btn col-sm-2 btn-success">修改</button>
										   </div>
									   </div>
