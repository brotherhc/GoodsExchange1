									...
									<div class="col-xs-12">
										...
										<div class=" search_box">
											<div class="form-group clearfix">
												...
												<form:form modelAttribute="task" id="searchForm" action="" method="post">
													<input id="pageNo" name="pageNo" type="hidden" value="${evaluatePage.pageNo}"/>
													<input id="pageSize" name="pageSize" type="hidden" value="${evaluatePage.pageSize}"/>
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover xhbClass">
												...
												<c:forEach items="${evaluatePage.list}" var="page">
												<tbody>
													
													
													<tr>
														<td class="">${page.id}</td>
														<td class="">${page.goodsId}</td>
														<td class="">${page.content}</td>
														<td class="">${page.exchangeId}</td>
														<td class="">${page.type}</td>
														<td class="">${page.status}</td>
														<td class="">${page.updatedAt}</td>
														<td class="">${page.createdAt}</td>

														<td>
															<div><a class="visible-md visible-lg hidden-sm hidden-xs btn-group">


																<a href="${ctx}/Evaluate/index/?id=${page.id}"> <button tag="edit"   classTag="修改"  class="btn btn-xs btn-info" title="修改">
																	<i class="icon-edit bigger-120"></i>
																</button></a>
																<a href="${ctx}/Evaluate/delete?id=${page.id}" tag="edit"  style="cursor:pointer;" classTag="删除"  class="btn btn-xs btn-info" title="删除">
...
<![endif]-->
			...
			<script src="${ctxStatic}/assets/js/edit.js"></script>
