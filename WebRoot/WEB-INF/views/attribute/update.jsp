					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" action= "${ctx}/attribute/update/?id=${list.id}"role="form" method="post">

								   <div class="form-group">
								      <label for="lastname" class="col-sm-2 control-label">分类ID</label>
								      <div class="col-sm-5">
								         <input type="text" class="form-control" id="lastname" name="categoryId"
								            placeholder="" path="${categoryId}">
								      </div>
								   </div>
								   <div class="form-group">
								      <label for="lastname" class="col-sm-2 control-label">关键字名</label>
								      <div class="col-sm-5">
								         <input type="text" class="form-control" id="lastname1" name="name"
								            placeholder="" value="${list.name}">
								      </div>
								   </div>
								   <%--<div class="form-group">--%>
								      <%--<label for="lastname" class="col-sm-2 control-label">是否验证</label>--%>
								      <%--<div class="col-sm-5">--%>
								         <%--<input type="text" class="form-control" id="lastname2" name="isVerify"--%>
								            <%--placeholder="" path="${is_verify}">--%>
								      <%--</div>--%>
								   <%--</div>--%>
								   <%--<div class="form-group">--%>
								      <%--<label for="lastname" class="col-sm-2 control-label">邮箱key</label>--%>
								      <%--<div class="col-sm-5">--%>
								         <%--<input type="text" class="form-control" id="lastname3" name="emailKey"--%>
								            <%--placeholder="" path="${email_key}">--%>
								      <%--</div>--%>
								   <%--</div>--%>
									<%--<div class="form-group">--%>
										<%--<label for="lastname" class="col-sm-2 control-label">级别名称</label>--%>
										<%--<div class="col-sm-5">--%>
											<%--<input type="text" class="form-control" id="lastname4" name="userLevelName"--%>
												   <%--placeholder="" path="${user_level_name}">--%>
										<%--</div>--%>
									<%--</div>--%>
                                    <%--<div class="form-group">--%>
                                        <%--<label for="lastname" class="col-sm-2 control-label">第3方key</label>--%>
                                        <%--<div class="col-sm-5">--%>
                                            <%--<input type="text" class="form-control" id="lastname5" name="thirdpartyAccountKey"--%>
                                                   <%--placeholder="" path="${thirdpartyAccountKey}">--%>
                                        <%--</div>--%>
                                    <%--</div>--%>

                                    <div class="form-group">
                                                <div class="col-sm-offset-2 col-sm-6">
                                                    <button type="submit" class="btn col-sm-2 btn-success">确认添加</button>
                                                </div>
                                            </div>
								</form>
                                    </c:forEach>
