    ...
    <div class="main-container-inner">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <sf:form class="form-horizontal" modelAttribute="Attribute"  action="${ctx}/attribute/insert" method="post">
                            <div class="form-group">
                                <%--<label for="firstname" class="col-sm-2 control-label">分类ID</label>--%>
                                <div class="col-sm-5">
                                    <input type="hidden" class="form-control" id="firstname"name="categoryId"
                                           placeholder="" path="${categoryId}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="lastname" class="col-sm-2 control-label">属性名字</label>
                                <div class="col-sm-5">
                            ...
                            <%--<div class="form-group">--%>
                                <%--<label for="lastname" class="col-sm-2 control-label">属性类型</label>--%>
                                <%--<div class="col-sm-5">--%>
                                    <%--<input type="text" class="form-control" id="lastname1" name="attributeType"--%>
                                           <%--placeholder="" path = "${attributeType}">--%>
                                <%--</div>--%>
                            <%--</div>--%>
                            <%--<div class="form-group">--%>
                                <%--<label for="lastname" class="col-sm-2 control-label">添加属性次数</label>--%>
                                <%--<div class="col-sm-5">--%>
                                    <%--<input type="text" class="form-control" id="lastname2" name="attributeNumber"--%>
                                           <%--placeholder="" path = "${attributeNumber}">--%>
                                <%--</div>--%>
                            <%--</div>--%>
