			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<sf:form class="form-horizontal" action="${ctx}/user/insert" method="post" modelAttribute="User" role="form" >
								   ...
								   <div class="form-group">
								      ...
								      <div class="col-sm-5">
								         <input type="text" class="form-control" id="lastname1" name="email"
								   ...
								   <div class="form-group">
								      ...
								      <div class="col-sm-5">
								         <input type="text" class="form-control" id="lastname2" name="mobile"
								            placeholder="" path="${mobile}">
								      </div>
								   </div>
								   <div class="form-group">
								      <label for="lastname" class="col-sm-2 control-label">邮箱是否验证</label>
								      <div class="col-sm-5">
								         <input type="text" class="form-control" id="lastname3" name="isVerify"
								   ...
								   <div class="form-group">
								      ...
								      <div class="col-sm-5">
								         <input type="text" class="form-control" id="lastname4" name="emailKey"
