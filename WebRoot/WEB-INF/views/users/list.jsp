									...
									<div class="col-xs-12">
										...
										<div class=" search_box">
											<div class="form-group clearfix">
												...
												<form:form name="tb" modelAttribute="task" id="searchForm" action="" method="post">
													...
													<div class="col-sm-3 pt8">
														...
														<input id="text1" value="" type="text" class="form-control"  name="searchKey" placeholder="搜索">
															<a href="javascript:void(0)" class="search_btn" onclick="get()">
															<i class="icon-search nav-search-icon"></i>
														</a>
													</div>
												</form:form>
												<script type="text/javascript">
													function  get(){
														window.location.href="${ctx}/user/Search/?username="+document.tb.searchKey.value;
													}
												...
												<div class="col-sm-2 add_btn">
											      	...
											      	<a href="${ctx}/user/add/" class="btn btn-success">
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover xhbClass">
												...
												<tbody>
													...
													<tr>
														...
														<td class="name">${list.imei}</td>
                                                        <td>${list.email}</td>
														<td class="isVerify">${list.isVerify}</td>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																<a href="${ctx}/user/selectid/?id=${list.id}"> <button tag="edit"   classTag="修改"  class="btn btn-xs btn-info" title="修改">
																	<i class="icon-edit bigger-120"></i>
																</button></a>

                                                                <a href="${ctx}/user/del/${list.id}"><button class="btn btn-xs btn-danger" classTag="删除" title="删除" >
...
//			var inputVal = $("input[name='searchKey']").val();
//			alert(inputVal);
		</script>
