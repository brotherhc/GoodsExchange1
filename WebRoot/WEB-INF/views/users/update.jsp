					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" action= "${ctx}/user/update/?id=${list.id}"role="form" method="post">
								   ...
								   <div class="form-group">
								      ...
								      <div class="col-sm-5">
								         <input type="text" class="form-control" id="lastname" name="username"
								            placeholder="" value="${list.username}">
								      </div>
								   </div>
								   <div class="form-group">
								      <label for="lastname" class="col-sm-2 control-label">手机设备标识码</label>
								      <div class="col-sm-5">
								         <input type="text" class="form-control" id="lastname1" name="imei"
								            placeholder="" value="${list.imei}">
								      </div>
								   </div>
								   <div class="form-group">
								      <label for="lastname" class="col-sm-2 control-label">邮箱验证是否通过</label>
								      <div class="col-sm-5">
								         <input type="text" class="form-control" id="lastname2" name="isVerify"
								            placeholder=""value="${list.isVerify}">
								      </div>
								   </div>
								   <div class="form-group">
								      <label for="lastname" class="col-sm-2 control-label">账号类型</label>
								      <div class="col-sm-5">
								         <input type="text" class="form-control" id="lastname3" name="accountType"
								            placeholder="" value="${list.accountType}">
								      </div>
								   </div>
									<div class="form-group">
										<label for="lastname" class="col-sm-2 control-label">用户状态</label>
										<div class="col-sm-5">
											<input type="text" class="form-control" id="lastname4" name="state"
												   placeholder="" value="${list.state}">
										</div>
									</div>
                                    <div class="form-group">
                                        <label for="lastname" class="col-sm-2 control-label">是否管理员</label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="lastname5" name="isAdmin"
                                                   placeholder="" value="${list.isAdmin}">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                                <div class="col-sm-offset-2 col-sm-6">
                                                    <button type="submit" class="btn col-sm-2 btn-success">确认修改</button>
                                                </div>
                                            </div>
