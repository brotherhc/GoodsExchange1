					...
					<div class="page-content">
						...
						<div class="row">
							...
							<c:forEach var="list"  items="${List}">
								<form class="form-horizontal" action= "${ctx}/Requirements/update/?id=${list.id}"role="form" method="post">

								   <div class="form-group">
								      <label for="firstname" class="col-sm-2 control-label">用户id</label>
								      <div class="col-sm-5">
								         <input type="text" class="form-control" id="firstname" readonly="readonly"name="userId"
								            placeholder=""value="${list.userId}" >
								      </div>
								   </div>
								   <div class="form-group">
								      <label for="lastname" class="col-sm-2 control-label">分类id</label>
								      <div class="col-sm-5">
								         <input type="text" class="form-control" id="lastname1"name="categoryId"
								            placeholder=""value="${list.categoryId}">
								      </div>
								   </div>
								   <div class="form-group">
								      <label for="lastname" class="col-sm-2 control-label">描述</label>
								      <div class="col-sm-5">
								         <input type="text" class="form-control" id="lastname2" name="description"
								            placeholder=""value="${list.description}" >
								   ...
								   <div class="form-group">
								      <label for="lastname" class="col-sm-2 control-label">需求url</label>
								      <div class="col-sm-5">
								         <input type="text" class="form-control" id="lastname4"name="urls"
								            placeholder=""value="${list.urls}">
								      </div>
								   </div>
								   <div class="form-group">
								      <label for="lastname" class="col-sm-2 control-label">需求状态</label>
								      <div class="col-sm-5">
								         <input type="text" class="form-control" id="lastname"name="state"
								            placeholder=""value="${list.taskStateName}">
								      </div>
								   </div>
