...
-->
		...
		<script>
			function delMessage(id){
					if(confirm("你确定要删除吗？")){
						location.href="${ctx}/Requirements/delete?id=${goods.id}" + id;
					}
			}
			function page(){
					...
					<div class="page-content">
						...
						<div class="row">
									<div class="col-xs-12">
											...
											<div class="form-group clearfix">
											      <!--<label for="firstname" class=" control-label text-right">搜索</label>-->
													  <form:form modelAttribute="task" id="searchForm" action="" method="post">
														  <input id="pageNo" name="pageNo" type="hidden" value="${goodsList.pageNo}"/>
														  <input id="pageSize" name="pageSize" type="hidden" value="${goodsList.pageSize}"/>
														  ...
														  <div class="col-sm-2 add_btn">
															  ...
															  <a href="${ctx}/Goods/add" class="btn btn-success">
										...
										<div class="table-responsive tagnameClass">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														<td>${goods.userId.id}</td>
														<td>${goods.userId.username}</td>
														<td>${goods.categoryId.name}</td>
														<td>${goods.categoryId.parentName}</td>
														<%--<td>${goods.description}</td>--%>
														<%--<td>${goods.attributes}</td>--%>
														<%--<td>${goods.numbers}</td>--%>
														<td>${goods.taskStateName}</td>
														<%--<td>${goods.createdAt}</td>--%>

														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																<a href="${ctx}/Goods/add" tag="edit"  style="cursor:pointer;" classTag="修改"  class="btn btn-xs btn-info" title="修改">
																	<i class="icon-edit bigger-120"></i>
																</a>
																<a href="${ctx}/Goods/delete?id=${goods.id}" tag="edit"  style="cursor:pointer;" classTag="删除"  class="btn btn-xs btn-info" title="删除">
										...
										<div class="page" id="page">${goodsList}</div>
								</div>
